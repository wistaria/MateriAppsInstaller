...
check cmake -C../cmake/presets/std_nolib.cmake -DBUILD_MPI=yes -DBUILD_OMP=yes -DBUILD_EXE=yes -DBUILD_LIB=yes -DBUILD_SHARED_LIBS=yes -DCMAKE_INSTALL_PREFIX=$PREFIX ../cmake 2>&1 | tee -a $LOG
