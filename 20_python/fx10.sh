...
echo "[pip]" | tee -a $LOG
cd $BUILD_DIR/Python-$PYTHON_VERSION
env LD_LIBRARY_PATH=$PREFIX_FRONTEND/lib:$LD_LIBRARY_PATH $PREFIX_FRONTEND/bin/python get-pip.py | tee -a $LOG
env LD_LIBRARY_PATH=$PREFIX_FRONTEND/lib:$LD_LIBRARY_PATH $PREFIX_FRONTEND/bin/pip install --upgrade pip
...
env LD_LIBRARY_PATH=$PREFIX_FRONTEND/lib:$LD_LIBRARY_PATH $PREFIX_FRONTEND/bin/python setup.py install | tee -a $LOG
...
env LD_LIBRARY_PATH=$PREFIX_FRONTEND/lib:$LD_LIBRARY_PATH $PREFIX_FRONTEND/bin/pip install matplotlib | tee -a $LOG

echo "[ipython]" | tee -a $LOG
env LD_LIBRARY_PATH=$PREFIX_FRONTEND/lib:$LD_LIBRARY_PATH $PREFIX_FRONTEND/bin/pip install sphinx pyzmq tornado ipython | tee -a $LOG

echo "[virtualenv]" | tee -a $LOG
env LD_LIBRARY_PATH=$PREFIX_FRONTEND/lib:$LD_LIBRARY_PATH $PREFIX_FRONTEND/bin/pip install virtualenv | tee -a $LOG

echo "[mock]" | tee -a $LOG
env LD_LIBRARY_PATH=$PREFIX_FRONTEND/lib:$LD_LIBRARY_PATH $PREFIX_FRONTEND/bin/pip install mock | tee -a $LOG
