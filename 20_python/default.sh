...
LD_LIBRARY_PATH=$PREFIX_TOOL/lib:$LD_LIBRARY_PATH check $PREFIX_TOOL/bin/python2.7 setup.py build
$SUDO LD_LIBRARY_PATH=$PREFIX_TOOL/lib:$LD_LIBRARY_PATH $PREFIX_TOOL/bin/python2.7 setup.py install
