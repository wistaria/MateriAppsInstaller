...
check env LD_LIBRARY_PATH=$PREFIX_OPT/Linux-x86_64/lib:$LD_LIBRARY_PATH $PREFIX_OPT/Linux-x86_64/bin/python2.7 setup.py build
$SUDO env LD_LIBRARY_PATH=$PREFIX_OPT/Linux-x86_64/lib:$LD_LIBRARY_PATH $PREFIX_OPT/Linux-x86_64/bin/python2.7 setup.py install
...
check env LD_LIBRARY_PATH=$PREFIX_OPT/Linux-x86_64/lib:$LD_LIBRARY_PATH $PREFIX_OPT/Linux-x86_64/bin/python2.7 setup.py build --zmq=$PREFIX_OPT
$SUDO env LD_LIBRARY_PATH=$PREFIX_OPT/Linux-x86_64/lib:$LD_LIBRARY_PATH $PREFIX_OPT/Linux-x86_64/bin/python2.7 setup.py install
