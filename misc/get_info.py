...
url_list = []
url_list.append("https://ma.issp.u-tokyo.ac.jp/en/app/#gsc.tab=0")#
#for idx in list(range(0,27)):
for idx in range(27):
    url_list.append("https://ma.issp.u-tokyo.ac.jp/en/app/page/{}#gsc.tab=0".format(idx+2))
...
with h5py.File("materiapps_info.h5", "w") as fw:
    for idx, url in enumerate(url_list):
        ...
        #Get App's URL
        elems = soup.find_all(href=re.compile("/en/app/[0-9]+"), text=re.compile("To Detail"))
