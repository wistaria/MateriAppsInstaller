...
echo "[make]" | tee -a $LOG
check ./configure --prefix=$PREFIX FC=mpif90 FCFLAGS="-O3 -openmp -parallel -cpp -DMPIPARA -DCOMM_CUBE -DFJMPIDIR -DSYNC_COM -DHALFDIRE -DONEPROC_AXIS -DSEGSHAKE" | tee -a $LOG
